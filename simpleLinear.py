...
def main():
    ...
    print("b0 T Value ->", results['intercept']['t_value'])
    print("b0 P Value ->", results['intercept']['p_value'])
    print("Slope ->", results['slope']['b1'])
    print("Standard Error b1 ->", results['slope']['std_error'])
    print("b1 95 percent Confidence Interval ->", results['slope']['confidence_interval'])
    print("b1 T Value ->", results['slope']['t_value'])
    print("b1 P Value ->", results['slope']['p_value'])
    print("Equation -> ", results['equation'])
